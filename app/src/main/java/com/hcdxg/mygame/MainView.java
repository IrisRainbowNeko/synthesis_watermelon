...
public class MainView extends GameView
{
	...
	boolean diatc;
	public MainView(){
		Image title=new Image(345,300,390,100);
		title.setbitmap(tool.loadbitmap("title.png"));
		Button ks=new Button();
		ks.settextsize(70);
		ks.settext("开始游戏");
		ks.setsize(350,150);
		ks.setposition_center(540,800);
		...
		sm.settext("说明");
		sm.setsize(350,150);
		sm.setposition_center(540,1000);
		...
		tc.settext("退出");
		tc.setsize(350,150);
		tc.setposition_center(540,1200);
		...
		gv.settext("设置");
		gv.setsize(350,150);
		gv.setposition_center(540,1400);
